This repository contains a Python notebook for classifying small images from the CIFAR-10 dataset using a Convolutional Neural Network (CNN) implemented in TensorFlow and Keras.
